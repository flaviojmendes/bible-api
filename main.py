...
async def get_book(book_id: int):
    ...
    paragraph4 = ParagraphModel(text="Agora que expliquei o título, passo a escrever o livro. Antes disso, porém, digamos os motivos que me põem a pena na mão.")
    ...
    chapter1 = ChapterModel(title="CAPÍTULO I", paragraphs=[paragraph1, paragraph2, paragraph3])
